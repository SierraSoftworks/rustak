...
(MapLibre GL and milsymbol) and the MIL-STD-2525 symbol tables its pickers
search (`mil-std-2525`) are pinned in `rustak-ui/package.json` and copied or derived
